 ...
 <div>
     ...
     <div style="text-align: center; margin-bottom: 1.5rem;">
         ...
         <h1 style="color: #4a5568; font-size: 1.5rem; font-weight: 700; margin-top: 1rem; margin-bottom: 1rem;">Crop
             Destruction Claim Summary</h1>
     </div>
     ...
     <div
         ...
         <div style="margin-bottom: 1.5rem;">
             ...
             <input type="text" type="text" readonly value="{{ $cropDestruction->claimant->name }}"
         ...
         <div style="display: flex; margin-bottom: 1.5rem; width:100%;justify-content: space-between; ">
             <div style="display:flex; align-items:center; margin-left: 0.5rem;">
                 ...
                 <input type="text" type="text" readonly value="{{ $cropDestruction->claimant->sex }}"
                     style="box-shadow: 0 0 5px rgba(0,0,0,0.1); border: 1px solid #E2E8F0; border-radius: 0.375rem; width: 100%; padding: 0.5rem 1rem; color: #4A5568; line-height: 1.5; outline: none;">
             </div>
             ...
             <div style="display:flex; align-items:center;  margin-left: 0.5rem;">
                 ...
                 <input type="text" type="text" readonly value="{{ $cropDestruction->claimant->age }}"
                     style="box-shadow: 0 0 5px rgba(0,0,0,0.1); border: 1px solid #E2E8F0; border-radius: 0.375rem;  width: 100%; padding: 0.5rem 1rem; color: #4A5568; line-height: 1.5; outline: none;">
             </div>
         ...
         <div style="display: flex; margin-bottom: 1.5rem; width:100%;justify-content: space-between; ">
             <div style="display:flex; align-items:center; margin-left: 0.5rem;">
                 <label
                     style="display: block; color: #4A5568; font-size: 0.875rem; font-weight: bold; margin-bottom: 0.5rem;">Present
                     Address:</label>
                 <input type="text" type="text" readonly value="{{ $cropDestruction->claimant->address }}"
                     style="box-shadow: 0 0 5px rgba(0,0,0,0.1); border: 1px solid #E2E8F0; border-radius: 0.375rem; width: 100%; padding: 0.5rem 1rem; color: #4A5568; line-height: 1.5; outline: none;">
             </div>
             ...
             <div style="display:flex; align-items:center;  margin-left: 0.5rem;">
                 ...
                 <input type="text" type="text" readonly value="{{ $cropDestruction->claimant->constituency }}"
                     style="box-shadow: 0 0 5px rgba(0,0,0,0.1); border: 1px solid #E2E8F0; border-radius: 0.375rem; width: 100%; padding: 0.5rem 1rem; color: #4A5568; line-height: 1.5; outline: none;">
             </div>
         ...
         <div style="display: flex; margin-bottom: 1.5rem; width:100%;justify-content: space-between; ">
             <div style="display:flex; align-items:center; margin-left: 0.5rem;">
                 ...
                 <input type="text" type="text" readonly value="{{ $cropDestruction->claimant->email }}"
                     style="box-shadow: 0 0 5px rgba(0,0,0,0.1); border: 1px solid #E2E8F0; border-radius: 0.375rem; width: 100%; padding: 0.5rem 1rem; color: #4A5568; line-height: 1.5; outline: none;">
             </div>
             ...
             <div style="display:flex; align-items:center;  margin-left: 0.5rem;">
                 ...
                 <input type="text" type="text" readonly value="{{ $cropDestruction->claimant->tel_no }}"
                     style="box-shadow: 0 0 5px rgba(0,0,0,0.1); border: 1px solid #E2E8F0; border-radius: 0.375rem; width: 100%; padding: 0.5rem 1rem; color: #4A5568; line-height: 1.5; outline: none;">
             </div>
         ...
         <div style="display: flex; margin-bottom: 1.5rem; width:100%;justify-content: space-between; ">
             <div style="display:flex; align-items:center; margin-left: 0.5rem;">
                 ...
                 <input type="text" type="text" readonly value="{{ $cropDestruction->claimant->county }}"
                     style="box-shadow: 0 0 5px rgba(0,0,0,0.1); border: 1px solid #E2E8F0; border-radius: 0.375rem; width: 100%; padding: 0.5rem 1rem; color: #4A5568; line-height: 1.5; outline: none;">
             </div>
             ...
             <div style="display:flex; align-items:center;  margin-left: 0.5rem;">
                 <label
                     ...
                     County:</label>
                 <input type="text" type="text" readonly value="{{ $cropDestruction->claimant->sub_county }}"
                     style="box-shadow: 0 0 5px rgba(0,0,0,0.1); border: 1px solid #E2E8F0; border-radius: 0.375rem; width: 100%; padding: 0.5rem 1rem; color: #4A5568; line-height: 1.5; outline: none;">
             </div>
         ...
         <div style="display: flex; margin-bottom: 1.5rem; width:100%;justify-content: space-between; ">
             <div style="display:flex; align-items:center; margin-left: 0.5rem;">
                 ...
                 <input type="text" type="text" readonly value="{{ $cropDestruction->claimant->location }}"
                     style="box-shadow: 0 0 5px rgba(0,0,0,0.1); border: 1px solid #E2E8F0; border-radius: 0.375rem; width: 100%; padding: 0.5rem 1rem; color: #4A5568; line-height: 1.5; outline: none;">
             </div>
             ...
             <div style="display:flex; align-items:center;  margin-left: 0.5rem;">
                 <label
                     style="display: block; color: #4A5568; font-size: 0.875rem; font-weight: bold; margin-bottom: 0.5rem;">Sub
                     Location:</label>
                 <input type="text" type="text" readonly value="{{ $cropDestruction->claimant->sub_location }}"
                     style="box-shadow: 0 0 5px rgba(0,0,0,0.1); border: 1px solid #E2E8F0; border-radius: 0.375rem; width: 100%; padding: 0.5rem 1rem; color: #4A5568; line-height: 1.5; outline: none;">
             </div>

         </div>
         <h3 style="color: #4A5568; font-size: 1.125rem; font-weight: 600; margin-bottom: 1rem;">Next of Kin Details
         </h3>
         <div style="display: flex; margin-bottom: 1.5rem; width:100%;justify-content: space-between; ">
             <div style="display:flex; align-items:center; margin-left: 0.5rem;">
                 <label
                     ...
                     of Kin Name:</label>
                 <input type="text" type="text" readonly value="{{ $next_of_kin->name }}"
                     style="box-shadow: 0 0 5px rgba(0,0,0,0.1); border: 1px solid #E2E8F0; border-radius: 0.375rem; width: 100%; padding: 0.5rem 1rem; color: #4A5568; line-height: 1.5; outline: none;">
             </div>
             ...
             <div style="display:flex; align-items:center;  margin-left: 0.5rem;">
                 ...
                 <input type="text" type="text" readonly value="{{ $next_of_kin->address }}"
                     style="box-shadow: 0 0 5px rgba(0,0,0,0.1); border: 1px solid #E2E8F0; border-radius: 0.375rem; width: 100%; padding: 0.5rem 1rem; color: #4A5568; line-height: 1.5; outline: none;">
             </div>
         ...
         <div style="display: flex; margin-bottom: 1.5rem; width:100%;justify-content: space-between; ">
             <div style="display:flex; align-items:center; margin-left: 0.5rem;">
                 <label
                     style="display: block; color: #4A5568; font-size: 0.875rem; font-weight: bold; margin-bottom: 0.5rem;">Email:</label>
                 <input type="text" type="text" readonly value="{{ $next_of_kin->email }}"
                     style="box-shadow: 0 0 5px rgba(0,0,0,0.1); border: 1px solid #E2E8F0; border-radius: 0.375rem; width: 100%; padding: 0.5rem 1rem; color: #4A5568; line-height: 1.5; outline: none;">
             </div>
             ...
             <div style="display:flex; align-items:center;  margin-left: 0.5rem;">
                 <label
                     style="display: block; color: #4A5568; font-size: 0.875rem; font-weight: bold; margin-bottom: 0.5rem;">Telephone:</label>
                 <input type="text" type="text" readonly value="{{ $next_of_kin->tel_no }}"
                     style="box-shadow: 0 0 5px rgba(0,0,0,0.1); border: 1px solid #E2E8F0; border-radius: 0.375rem; width: 100%; padding: 0.5rem 1rem; color: #4A5568; line-height: 1.5; outline: none;">
             </div>
         ...
         <div style="display: flex; margin-bottom: 1.5rem; width:100%;justify-content: space-between; ">
             <div style="display:flex; align-items:center; margin-left: 0.5rem;">
                 <label
                     style="display: block; color: #4A5568; font-size: 0.875rem; font-weight: bold; margin-bottom: 0.5rem;">County:</label>
                 <input type="text" type="text" readonly value="{{ $next_of_kin->county }}"
                     style="box-shadow: 0 0 5px rgba(0,0,0,0.1); border: 1px solid #E2E8F0; border-radius: 0.375rem; width: 100%; padding: 0.5rem 1rem; color: #4A5568; line-height: 1.5; outline: none;">
             </div>
             ...
             <div style="display:flex; align-items:center;  margin-left: 0.5rem;">
                 <label
                     style="display: block; color: #4A5568; font-size: 0.875rem; font-weight: bold; margin-bottom: 0.5rem;">Sub
                     County:</label>
                 <input type="text" type="text" readonly value="{{ $next_of_kin->sub_county }}"
                     style="box-shadow: 0 0 5px rgba(0,0,0,0.1); border: 1px solid #E2E8F0; border-radius: 0.375rem; width: 100%; padding: 0.5rem 1rem; color: #4A5568; line-height: 1.5; outline: none;">
             </div>
         ...
         <div style="display: flex; margin-bottom: 1.5rem; width:100%;justify-content: space-between; ">
             <div style="display:flex; align-items:center; margin-left: 0.5rem;">
                 <label
                     style="display: block; color: #4A5568; font-size: 0.875rem; font-weight: bold; margin-bottom: 0.5rem;">Location:</label>
                 <input type="text" type="text" readonly value="{{ $next_of_kin->location }}"
                     style="box-shadow: 0 0 5px rgba(0,0,0,0.1); border: 1px solid #E2E8F0; border-radius: 0.375rem; width: 100%; padding: 0.5rem 1rem; color: #4A5568; line-height: 1.5; outline: none;">
             </div>
             ...
             <div style="display:flex; align-items:center;  margin-left: 0.5rem;">
                 <label
                     style="display: block; color: #4A5568; font-size: 0.875rem; font-weight: bold; margin-bottom: 0.5rem;">Sub
                     Location:</label>
                 <input type="text" type="text" readonly value="{{ $next_of_kin->sub_location }}"
                     style="box-shadow: 0 0 5px rgba(0,0,0,0.1); border: 1px solid #E2E8F0; border-radius: 0.375rem; width: 100%; padding: 0.5rem 1rem; color: #4A5568; line-height: 1.5; outline: none;">
             </div>
         ...
         <div style="display: flex; margin-bottom: 1.5rem; width:100%;justify-content: space-between; ">
            <div style="display:flex; align-items:center; margin-left: 0.5rem;">
             ...
             Name:</label>
         <input type="text" type="text" readonly value="{{ $chiefs_comments->chief_name }}"
             style="box-shadow: 0 0 5px rgba(0,0,0,0.1); border: 1px solid #E2E8F0; border-radius: 0.375rem; width: 100%; padding: 0.5rem 1rem; color: #4A5568; line-height: 1.5; outline: none;">
            </div>
            ...
            <div style="display:flex; align-items:center;  margin-left: 0.5rem;">
                ...
                style="display: block; color: #4A5568; font-size: 0.875rem; font-weight: bold; margin-bottom: 0.5rem;">Chief
                Phone:</label>
            <input type="text" type="text" readonly value="{{ $chiefs_comments->chief_phone }}"
                style="box-shadow: 0 0 5px rgba(0,0,0,0.1); border: 1px solid #E2E8F0; border-radius: 0.375rem; width: 100%; padding: 0.5rem 1rem; color: #4A5568; line-height: 1.5; outline: none;">
            </div>
 ...
 <div style="margin-top: 2.5rem;">
     ...
     <div style="margin-bottom: 1rem;">
         <label
             ...
             Circumstances of Incident:</label>
         <textarea readonly rows="3"
     ...
     <div style="margin-bottom: 1rem;">
         <label
             ...
             Crop Name:</label>
         <input type="text" type="text" readonly value="{{ $cropDestruction->crop_name }}"
     ...
     <div style="margin-bottom: 1rem;">
         ...
         <input type="text" type="text" readonly value="{{ $cropDestruction->animal_responsible }}"
             style="box-shadow: 0 0 5px rgba(0,0,0,0.1); appearance: none; border: 1px solid #E2E8F0; border-radius: 0.375rem; width: 100%; padding: 0.5rem 1rem; color: #4A5568; line-height: 1.5; outline: none;">
     </div>

     <div style="margin-bottom: 1rem;">
         <label
             style="display: block; color: #4A5568; font-size: 0.875rem; font-weight: bold; margin-bottom: 0.5rem;">4.
             Land Ownership
             Status:</label>
         <input type="text" type="text" readonly value="{{ $cropDestruction->land_ownership_status }}"
             style="box-shadow: 0 0 5px rgba(0,0,0,0.1); appearance: none; border: 1px solid #E2E8F0; border-radius: 0.375rem; width: 100%; padding: 0.5rem 1rem; color: #4A5568; line-height: 1.5; outline: none;">
     </div>
     ...
     <div style="margin-bottom: 1rem;">
         <label
             ...
             Approximate Acreage
             Destroyed:</label>
         <input type="text" type="text" readonly value="{{ $cropDestruction->acreage }}"
             style="box-shadow: 0 0 5px rgba(0,0,0,0.1); appearance: none; border: 1px solid #E2E8F0; border-radius: 0.375rem; width: 100%; padding: 0.5rem 1rem; color: #4A5568; line-height: 1.5; outline: none;">
     </div>
     ...
     <div style="margin-bottom: 1rem;">
         <label
             ...
             Stage of Growth:</label>
         <input type="text" type="text" readonly value="{{ $cropDestruction->stage }}"
             style="box-shadow: 0 0 5px rgba(0,0,0,0.1); appearance: none; border: 1px solid #E2E8F0; border-radius: 0.375rem; width: 100%; padding: 0.5rem 1rem; color: #4A5568; line-height: 1.5; outline: none;">
     </div>

     <div style="margin-bottom: 1rem;">
         <label
             style="display: block; color: #4A5568; font-size: 0.875rem; font-weight: bold; margin-bottom: 0.5rem;">7.
             Estimated Value:</label>
         <input type="text" type="text" readonly value="KSH {{ $cropDestruction->value }}"
             style="box-shadow: 0 0 5px rgba(0,0,0,0.1); appearance: none; border: 1px solid #E2E8F0; border-radius: 0.375rem; width: 100%; padding: 0.5rem 1rem; color: #4A5568; line-height: 1.5; outline: none;">
     </div>

     <div style="margin-bottom: 1rem;">
         <label
             style="display: block; color: #4A5568; font-size: 0.875rem; font-weight: bold; margin-bottom: 0.5rem;">8.
             Measures in Place:</label>
         <textarea readonly rows="3"
     ...
     <div style="margin-bottom: 1rem;">
         <label
             style="display: block; color: #4A5568; font-size: 0.875rem; font-weight: bold; margin-bottom: 0.5rem;">9.
             Place of Incident:</label>
         <input type="text" type="text" readonly value="{{ $cropDestruction->place }}"
             style="box-shadow: 0 0 5px rgba(0,0,0,0.1); appearance: none; border: 1px solid #E2E8F0; border-radius: 0.375rem; width: 100%; padding: 0.5rem 1rem; color: #4A5568; line-height: 1.5; outline: none;">
     </div>

     <div style="margin-bottom: 1rem;">
         <label
             style="display: block; color: #4A5568; font-size: 0.875rem; font-weight: bold; margin-bottom: 0.5rem;">10.
             Location Status:</label>
         <input type="text" type="text" readonly value="{{ $cropDestruction->location_status }}"
             style="box-shadow: 0 0 5px rgba(0,0,0,0.1); appearance: none; border: 1px solid #E2E8F0; border-radius: 0.375rem; width: 100%; padding: 0.5rem 1rem; color: #4A5568; line-height: 1.5; outline: none;">
     </div>

     <div style="margin-bottom: 1rem;">
         <label
             style="display: block; color: #4A5568; font-size: 0.875rem; font-weight: bold; margin-bottom: 0.5rem;">11.
             Date and Time of
             Incident:</label>
         <div style="display: flex; justify-content: normal;">
             <input type="text" type="text" readonly value="{{ $cropDestruction->date }}"
             ...
             <input type="text" type="text" readonly value="{{ $cropDestruction->time }}"
